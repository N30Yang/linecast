...
ASTERISMS = [
    {"name": "Big Dipper",
     ...
     "names": {"fr": "Grande Casserole", "es": "El Carro", "de": "Großer Wagen",
               ...
               "eo": "Granda Ĉaro", "tr": "Büyük Kepçe", "ru": "Большой Ковш", "ro": "Carul Mare", "cs": "Velký vůz"}},
    {"name": "Little Dipper",
     ...
     "names": {"fr": "Petite Casserole", "es": "Carro Menor", "de": "Kleiner Wagen",
               ...
               "zh-Hant": "小北斗",
               "eo": "Malgranda Ĉaro", "tr": "Küçük Kepçe", "ru": "Малый Ковш", "ro": "Carul Mic", "cs": "Malý vůz"}},
    {"name": "Summer Triangle",
     ...
     "names": {"fr": "Triangle d'été", "es": "Triángulo de verano", "de": "Sommerdreieck",
               ...
               "zh-Hant": "夏季大三角",
               "vi": "Tam Giác Mùa Hè",
               "eo": "Somera Triangulo", "tr": "Yaz Üçgeni", "ru": "Летний треугольник", "ro": "Triunghiul de vară", "cs": "Letní trojúhelník"}},
    {"name": "Winter Triangle",
     ...
     "names": {"fr": "Triangle d'hiver", "es": "Triángulo de invierno", "de": "Winterdreieck",
               ...
               "eo": "Vintra Triangulo", "tr": "Kış Üçgeni", "ru": "Зимний треугольник", "ro": "Triunghiul de iarnă", "cs": "Zimní trojúhelník"}},
    {"name": "Winter Hexagon",
     ...
     "names": {"fr": "Hexagone d'hiver", "es": "Hexágono de invierno", "de": "Wintersechseck",
               ...
               "eo": "Vintra Seslatero", "tr": "Kış Altıgeni", "ru": "Зимний шестиугольник", "ro": "Hexagonul de iarnă", "cs": "Zimní šestiúhelník"}},
    {"name": "Spring Triangle",
     ...
     "names": {"fr": "Triangle de printemps", "es": "Triángulo de primavera",
               ...
               "eo": "Printempa Triangulo", "tr": "İlkbahar Üçgeni", "ru": "Весенний треугольник", "ro": "Triunghiul de primăvară", "cs": "Jarní trojúhelník"}},
    {"name": "Great Square of Pegasus",
     ...
     "names": {"fr": "Grand Carré de Pégase", "es": "Cuadrado de Pegaso", "de": "Herbstviereck",
               ...
               "zh-Hant": "秋季四邊形",
               "eo": "Granda Kvadrato de Pegazo", "tr": "Pegasus'un Büyük Karesi", "ru": "Большой квадрат Пегаса", "ro": "Pătratul lui Pegas", "cs": "Pegasův čtverec"}},
    {"name": "Northern Cross",
     ...
     "names": {"fr": "Croix du Nord", "es": "Cruz del Norte", "de": "Kreuz des Nordens",
               ...
               "zh-Hant": "北十字",
               "eo": "Norda Kruco", "tr": "Kuzey Haçı", "ru": "Северный Крест", "ro": "Crucea Nordului", "cs": "Severní kříž"}},
    {"name": "Orion's Belt",
     ...
     "names": {"fr": "Baudrier d'Orion", "es": "Cinturón de Orión", "de": "Oriongürtel",
               ...
               "zh-Hant": "獵戶座腰帶",
               "eo": "Zono de Oriono", "tr": "Orion Kuşağı", "ru": "Пояс Ориона", "ro": "Centura lui Orion", "cs": "Orionův pás"}},
    {"name": "Teapot",
     ...
     "names": {"fr": "Théière", "es": "Tetera", "de": "Teekanne", "it": "Teiera",
               ...
               "eo": "Tekruĉo", "tr": "Çaydanlık", "ru": "Чайник", "ro": "Ceainicul", "cs": "Čajová konvice"}},
    {"name": "Sickle of Leo",
    ...
    {"name": "False Cross",
     ...
     "names": {"fr": "Fausse Croix", "es": "Falsa Cruz", "de": "Falsches Kreuz",
               ...
               "zh-Hant": "假十字",
               "eo": "Falsa Kruco", "tr": "Sahte Haç", "ru": "Ложный Крест", "ro": "Crucea Falsă", "cs": "Falešný kříž"}},
